...
export const BillsModal = ({ isOpen, onClose }) => {
  const [bills, setBills] = useState([
    { id: 1, name: 'Rent', amount: 1200, dueDate: '2023-05-15', paid: false },
    { id: 2, name: 'Electricity', amount: 85, dueDate: '2023-05-20', paid: true },
    { id: 3, name: 'Internet', amount: 70, dueDate: '2023-05-25', paid: false },
  ]);
